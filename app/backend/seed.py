...
async def seed_returns(db):
    ...
    data = [
        ...
        # 11. На рассмотрении завода (брак — завод проводит экспертизу)
        dict(id=11, number="ВЗ-000011", client_id=1, return_type="Ненадлежащее качество", kind="defect", reason_id=3,
             status="factory_review", manager_id=3, warehouse_id=1, date="2025-05-22",
             comment="Производственный брак — вздутие торцов досок",
             items=[("Ламинат Egger PRO Aqua+ EPL192 Дуб Ноублэнд", "EPL192", 5, "уп.", "1990")],
             checks=[], docs=[("claim_letter", "2025-05-23")], onec_docs=[],
             claim=dict(supplier_id=5, transfer="2025-05-23T10:00:00"),
             history=[("2025-05-22 09:00", "Обращение зарегистрировано", 3, None, "created"),
                      ("2025-05-22 09:30", "Условия соблюдены, запрошены данные покупателя", 3, "created", "client_data"),
                      ("2025-05-23 10:00", "Сформирована и направлена претензия заводу", 4, "client_data", "claim_factory"),
                      ("2025-05-24 11:00", "Завод принял претензию к рассмотрению (экспертиза)", 4, "claim_factory", "factory_review")]),
    ]
